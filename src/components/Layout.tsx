          ...
          <div className="flex justify-between items-center h-20">
            ...
            <Link to="/" className="flex items-center space-x-3 group">
              <div className="relative">
                <div className="w-12 h-12 bg-gradient-to-br from-[#0595f6] to-blue-500 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              {navItems.map((item) => (
                ...
                >
                  {item.name}
                  {location.pathname === item.path && (
                    <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-[#0595f6] rounded-full"></div>
                  )}
                </Link>
              ))}
              <Link
            ...
            <button
              ...
              className="lg:hidden p-3 rounded-xl bg-gray-100 hover:bg-[#0595f6]/10 transition-all duration-300 hover:scale-105"
            >
              {isMenuOpen ? (
          ...
          <div className="bg-white/95 backdrop-blur-xl border-t border-gray-100 shadow-2xl">
            <div className="max-w-7xl mx-auto px-4 py-6">
              <nav className="space-y-4">
                ...
                <Link
                  to="/#waitlist"
                  className="block bg-gradient-to-r from-[#0595f6] to-blue-500 text-white px-6 py-4 rounded-2xl font-semibold text-center hover:shadow-xl transition-all duration-300 hover:scale-105 mt-6"
                >
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-[#0595f6] to-blue-500 rounded-2xl flex items-center justify-center shadow-lg">
                  <Sparkles className="text-white" size={24} />
                </div>
                <div>
