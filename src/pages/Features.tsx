        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Revolutionary AI-powered automation that transforms how you apply
              to jobs
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Revolutionary bulk application technology that applies to hundreds of relevant positions with a single click",
              ...
              },
              {
                ...
                description:
                  "Get instant compatibility scores for every LinkedIn job, ensuring maximum application success rates",
              ...
              },
              {
                ...
                description:
                  "Advanced AI technology that intelligently fills out job application forms with perfect accuracy",
              ...
              },
              {
                ...
                description:
                  "Smart algorithms analyze job requirements and match them perfectly with your skills and experience",
              ...
              },
              {
                ...
                description:
                  "Comprehensive tracking and analytics to monitor your application success and optimize your strategy",
              ...
              },
              {
                ...
                description:
                  "Automatically optimize your resume for each specific role to maximize ATS compatibility",
              ...
              return (
                ...
                >
                  <div
                    className={`bg-gradient-to-br ${feature.gradient}/10 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
                    <Icon
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 to-blue-50/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert human professionals dedicated to accelerating your career
              success
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Expert-crafted, personalized cover letters for each application that highlight your unique value proposition",
                gradient: "from-blue-500 to-purple-500",
              },
              {
                icon: Target,
                ...
                description:
                  "Human expertise in identifying the perfect roles that align with your career goals and skill set",
                gradient: "from-purple-500 to-pink-500",
              },
              {
                icon: Star,
                ...
                description:
                  "Comprehensive interview coaching and preparation sessions to maximize your success rate",
                gradient: "from-pink-500 to-red-500",
              },
              {
                icon: Activity,
                ...
                description:
                  "Detailed daily reports on application progress, responses, and strategic recommendations",
                gradient: "from-red-500 to-orange-500",
              },
              {
                icon: Award,
                ...
                description:
                  "Professional career guidance and strategic planning to accelerate your professional growth",
                gradient: "from-orange-500 to-yellow-500",
              },
              {
                icon: Clock,
                ...
                description:
                  "Round-the-clock support from your dedicated agent team for any questions or concerns",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-black text-gray-900 mb-8">
              Powered by{" "}
              <span className="text-[#0595f6]">Advanced Technology</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Built on cutting-edge AI and machine learning technologies for
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Processing millions of job postings for optimal matching",
              },
              {
                icon: Network,
                title: "Cloud Infrastructure",
                description:
                  "Scalable, secure, and lightning-fast global network",
              },
              {
                icon: Eye,
            ...
            {[
              {
                ...
                description:
                  "All data is encrypted with AES-256 encryption, the same standard used by banks and government agencies",
              },
              {
                icon: Eye,
                title: "Zero Data Storage",
                description:
                  "We never store your personal information. All data is processed in real-time and immediately discarded",
              },
              {
                icon: CheckCircle,
