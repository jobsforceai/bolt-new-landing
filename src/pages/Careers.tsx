            ...
            <div className="grid md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              {[
                ...
                <div key={index} className="group bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:scale-105">
                  <stat.icon className="text-[#0595f6] mb-3 mx-auto" size={32} />
      ...
      <section className="py-24 bg-gradient-to-r from-[#0595f6] to-blue-500 text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <button className="border-2 border-white text-white px-12 py-5 rounded-2xl font-bold text-xl hover:bg-white hover:text-[#0595f6] transition-all duration-300 hover:scale-105 flex items-center gap-3 justify-center">
              <Heart size={24} />
